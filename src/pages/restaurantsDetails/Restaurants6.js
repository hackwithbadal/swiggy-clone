...
function Restaurants1() {
  return <div className='Restaurabts1Details'>
    <div>
      <Helmet><title>Swiggy | V.I.P Family Restaurant</title></Helmet>
    </div>
    ...
    <div className='restaurantHeading'>
      ...
      <div className="restaurantInfo">
        <h3 className='HotelNameInfo'>V.I.P Family Restaurant</h3>
      ...
      <div className='RestaurantsOffer'>
        <p id='promoCodeInfo'><MdOutlineLocalOffer />upto 500r cash back on google pay</p>
      </div>
    </div>
