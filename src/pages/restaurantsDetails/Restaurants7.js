...
function Restaurants1() {
  return <div className='Restaurabts1Details'>
    <div>
      <Helmet><title>Swiggy | Indiya Oye Radisson Blu</title></Helmet>
    </div>
    ...
    <div className='restaurantHeading'>
      ...
      <div className="restaurantInfo">
        <h3 className='HotelNameInfo'>Indiya Oye Radisson Blu</h3>
        <p className='hotelDescInfo '>Fast Food , Bevarages, bear</p>
        <div className='obj'>
          <div id='Hotelrating'>
            <h3>4.5</h3>
      ...
      <div className='RestaurantsOffer'>
        <p id='promoCodeInfo'><MdOutlineLocalOffer />20% in rupay credit card</p>
      </div>
    </div>
