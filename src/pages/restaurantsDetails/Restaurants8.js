...
function Restaurants1() {
  return <div className='Restaurabts1Details'>
    <div>
      <Helmet><title>Swiggy | Spice Jain Restaurant</title></Helmet>
    </div>
    ...
    <div className='restaurantHeading'>
      ...
      <div className="restaurantInfo">
        <h3 className='HotelNameInfo'>Spice Jain Restaurant</h3>
        <p className='hotelDescInfo '>vegen , juice ,breakfast</p>
        <div className='obj'>
          <div id='Hotelrating'>
            <h3>4.6</h3>
      ...
      <div className='RestaurantsOffer'>
        <p id='promoCodeInfo'><MdOutlineLocalOffer />100rs off on Paytm</p>
      </div>
    </div>
