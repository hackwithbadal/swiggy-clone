...
function Restaurants1() {
  return <div className='Restaurabts1Details'>
        <div>
      <Helmet><title>Swiggy | vibha celibration</title></Helmet>
    </div>
    ...
    <div className='restaurantHeading'>
      ...
      <div className="restaurantInfo">
        <h3 className='HotelNameInfo'>vibha celibration</h3>
        <p className='hotelDescInfo '>Beverages , wine , bear</p>
        <div className='obj'>
          <div id='Hotelrating'>
            <h3>4.7</h3>
      ...
      <div className='RestaurantsOffer'>
        <p id='promoCodeInfo'><MdOutlineLocalOffer />40% in SBI credit card</p>
      </div>
    </div>
